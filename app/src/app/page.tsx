  ...
  return (
    <div style={{ fontFamily: 'var(--font-geist-sans), system-ui, sans-serif', color: '#0A1628', background: '#FAF8F3', overflowX: 'hidden' }}>
      ...
      <nav style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 100, background: 'rgba(250,248,243,0.85)', backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', borderBottom: '1px solid rgba(10,22,40,0.08)' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '1rem 2rem', maxWidth: '1200px', margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', gap: '2rem', alignItems: 'center', fontSize: '0.875rem', color: '#6B7280' }}>
            <a href="#features" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }} className="hover:text-[#0A1628]">Features</a>
            <a href="#how" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }} className="hover:text-[#0A1628]">How it works</a>
            <a href="#market" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }} className="hover:text-[#0A1628]">Who it&apos;s for</a>
            <Link href="/login" style={{ textDecoration: 'none', color: '#6B7280', fontSize: '0.8125rem', fontWeight: 500, transition: 'color 0.15s' }}>Sign in</Link>
            <Link href="#waitlist" style={{ background: '#0A1628', color: '#FAF8F3', padding: '0.6rem 1.25rem', borderRadius: '100px', fontSize: '0.8125rem', fontWeight: 500, textDecoration: 'none', transition: 'background 0.2s' }}>Join waitlist</Link>
          </div>
        </div>
      </nav>

      {/* ── HERO ── */}
      <section style={{ padding: '10rem 0 6rem', position: 'relative', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <h1 className="animate-fade-up-1" style={{ fontFamily: 'var(--font-serif), Georgia, serif', fontWeight: 400, fontSize: 'clamp(3rem, 6.5vw, 5.5rem)', lineHeight: 0.98, letterSpacing: '-0.02em', color: '#0A1628', marginBottom: '1.5rem' }}>
                Your AI property<br />manager. <em style={{ fontStyle: 'italic', color: '#0D9E75' }}>Automated.</em>
              </h1>

              <p className="animate-fade-up-2" style={{ fontSize: 'clamp(1.05rem, 1.35vw, 1.2rem)', color: '#6B7280', maxWidth: '540px', lineHeight: 1.65, marginBottom: '2.5rem' }}>
              ...
              <div className="animate-fade-up-3" style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
                <Link href="/signup" style={{ background: '#0A1628', color: '#FAF8F3', padding: '0.95rem 1.75rem', borderRadius: '100px', fontSize: '0.95rem', fontWeight: 500, textDecoration: 'none', display: 'inline-flex', alignItems: 'center', gap: '0.5rem', transition: 'all 0.2s' }}>
                  Get started free →
                </Link>
                <a href="#how" style={{ padding: '0.95rem 1.75rem', borderRadius: '100px', fontSize: '0.95rem', fontWeight: 500, color: '#0A1628', border: '1px solid rgba(10,22,40,0.12)', background: 'transparent', textDecoration: 'none', transition: 'all 0.2s' }}>
                  See how it works
                </a>
              </div>

              <div className="animate-fade-up-4" style={{ display: 'flex', gap: '2rem', marginTop: '3rem', fontSize: '0.8125rem', color: '#6B7280' }}>
            ...
            <div className="animate-fade-up-5" style={{ position: 'relative', height: '520px' }}>
              {/* Glow */}
      ...
      <section style={{ background: '#0A1628', color: 'white', padding: '5rem 0', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', position: 'relative' }}>
          ...
          <p style={{ fontSize: '1.1rem', color: 'rgba(255,255,255,0.55)', maxWidth: '560px', marginBottom: '4rem', lineHeight: 1.6 }}>
            From the landlord with one flat to the agency with 200 units, most still run their business on WhatsApp, paper, and memory. The cost adds up.
          </p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
            {[
              ...
              <div key={i} style={{ padding: '2.5rem 1.5rem 2rem 0', borderBottom: '1px solid rgba(255,255,255,0.08)', borderRight: i < 3 ? '1px solid rgba(255,255,255,0.08)' : 'none', paddingLeft: i > 0 ? '1.5rem' : 0 }}>
                <div style={{ fontFamily: 'var(--font-serif), Georgia, serif', fontSize: '3.2rem', lineHeight: 1, color: '#1BC99A', marginBottom: '0.75rem' }}>{stat.num}</div>
      ...
      {/* ── FEATURES ── */}
      <section id="features" style={{ padding: '7rem 0 5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
            ...
            {[
              {
                ...
                body: 'Tenants get instant answers to maintenance requests, lease questions, and payment queries — 24/7, no calls to you.',
                icon: <path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"/>,
              },
              {
                title: 'Automated rent collection',
                body: 'EcoCash, PayFast, card — with smart WhatsApp reminders 7, 3, and 1 day before rent is due.',
                icon: <><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></>,
              },
              {
                title: 'Maintenance workflows',
                body: 'Tenants log issues with photos. AI triages priority. Contractors get assigned. Status tracked end-to-end.',
                icon: <path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/>,
              },
              {
                title: 'Portfolio dashboard',
                body: 'All your properties, occupancy rates, and revenue in one clean view. Scale to 100 units without adding headcount.',
                icon: <><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></>,
              },
              {
                title: 'Lease management',
                body: 'Digital lease signing, renewal reminders, and document storage — fully compliant and always accessible.',
                icon: <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></>,
              },
              {
                title: 'Built for Africa',
                body: 'Mobile-first design, EcoCash + PayFast integration, WhatsApp-native. Architecture that scales globally from day one.',
                icon: <><circle cx="12" cy="12" r="10"/><line x1="2" y1="12" x2="22" y2="12"/><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"/></>,
              },
            ].map((f, i) => (
              <div key={i} className="reveal feature-card" style={{ background: 'white', border: '1px solid rgba(10,22,40,0.08)', borderRadius: '16px', padding: '2rem 1.75rem', cursor: 'default' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          ...
          <div style={{ marginTop: '4rem' }}>
            {[
              ...
              <div key={i} className="reveal" style={{ display: 'grid', gridTemplateColumns: '60px 1fr', gap: '2rem', alignItems: 'flex-start', padding: '2.25rem 0', borderBottom: i < 2 ? '1px solid rgba(10,22,40,0.08)' : 'none' }}>
                ...
                <div>
                  <h3 style={{ fontFamily: 'var(--font-serif), Georgia, serif', fontSize: '1.75rem', fontWeight: 400, lineHeight: 1.15, color: '#0A1628', marginBottom: '0.5rem' }}>{step.title}</h3>
      ...
      {/* ── MARKET ── */}
      <section id="market" style={{ padding: '7rem 0 5rem' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div className="reveal">
      ...
      <section id="waitlist" style={{ padding: '7rem 0', background: '#0A1628', color: 'white', position: 'relative', overflow: 'hidden' }}>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem', position: 'relative', zIndex: 1 }}>
          <div style={{ textAlign: 'center', maxWidth: '640px', margin: '0 auto' }}>
            <h2 style={{ fontFamily: 'var(--font-serif), Georgia, serif', fontSize: 'clamp(2.25rem, 4.5vw, 3.5rem)', lineHeight: 1.05, letterSpacing: '-0.02em', color: 'white', marginBottom: '1.25rem' }}>
            ...
            <div style={{ marginTop: '2rem', paddingTop: '2rem', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
              ...
              <Link href="/login" style={{ display: 'inline-block', background: 'rgba(255,255,255,0.08)', color: 'white', padding: '0.75rem 1.75rem', borderRadius: '100px', fontSize: '0.9rem', fontWeight: 500, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.15)', transition: 'background 0.2s' }}>
                Sign in →
              </Link>
            </div>
          </div>
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 2rem' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
            ...
            <div style={{ display: 'flex', gap: '1.5rem', fontSize: '0.8125rem', color: '#6B7280' }}>
              <a href="mailto:founders@rentora.co" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }}>Contact</a>
              <a href="#" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }}>Privacy</a>
              <a href="#" style={{ textDecoration: 'none', color: 'inherit', transition: 'color 0.15s' }}>Terms</a>
            </div>
          </div>
        </div>
      </footer>
